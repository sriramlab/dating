/* example calling program for adaptive rejection sampling - normal mixtures */
...
int main(void)
{
  ...
  int neval,i;
  double xinit[10]={-3.0,0.0,12.0,20.0}, xl = -100.0,
          xr = 100.0;
  ...
  for(i=0;i<100000;i++){
    err = arms(xinit,ninit,&xl,&xr,normix,&normix_data,&convex,
